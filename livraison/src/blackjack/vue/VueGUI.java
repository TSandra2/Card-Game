...
public class VueGUI extends JFrame implements VueJeu {
    ...
    private JButton exit, newGame, newRound;
    ...
    private final List<PlayerPanel> playersPanels;
    ...
    private JPanel prepareControlPanel(){
        ...
        newGame.addActionListener(a -> ecouteur.onNouveauJeu());
    ...
    public void modeleMisAJour(Object partie) {
        if(partie instanceof PartieBlackjack){
            ...
            for(PlayerPanel panel: playersPanels){
                panel.update();
            }
